    ...
    this.service.add(this.editForm.value)
      .subscribe(
        result => {
          ...
          // @ts-ignore
          this.router.navigate(showUrl(BOOK_URL, result.data.createItem.id));
        },
        error => {
    ...
    this.service.update(this.editForm.value)
      .subscribe(
        result => {
          ...
          // @ts-ignore
          this.router.navigate(showUrl(BOOK_URL, result.data.updateItem.id));
        },
        error => {
          this.service.changeMessage(error.error ? error.error.message : error.message);
        }
